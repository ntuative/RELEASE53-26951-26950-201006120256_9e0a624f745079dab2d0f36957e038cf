package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_1016:LoaderContext;
      ...
      {
         super();
         var_685 = param2 == null ? "" : param2.url;
         _type = param1;
         var_14 = new Loader();
         var_1016 = new LoaderContext();
         var_1016.checkPolicyFile = true;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_394 < var_2482)
            {
               ...
               var_14.load(new URLRequest(var_685 + (var_685.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_394),var_1016);
               return true;
            }
         }
         return false;
