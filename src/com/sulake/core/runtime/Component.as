package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected var var_1191:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_1018:String = "";
      
      protected var var_2398:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_438:uint = 0;
      
      protected var var_2479:String = "";
      
      protected var var_16:IContext = null;
      
      protected var var_2003:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_1018 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1018);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1191 & const_832)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_438 + "]";
      }
