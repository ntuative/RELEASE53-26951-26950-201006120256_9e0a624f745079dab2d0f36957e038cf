package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1105:String = "zip-libraries";
      ...
      private var var_758:IEventDispatcher;
      
      private var var_926:Profiler;
      ...
      private var var_757:ProfilerViewer;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_681 = (param2 & 0) == Core.CORE_SETUP_DEBUG;
         var_543 = new Array();
         var_642 = new Array();
         var_220 = param1;
         var _loc3_:int = 0;
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_997:
               ...
               break;
            case Core.const_1214:
               debug("Core; using profiler frame update handler");
               var_220.addEventListener(Event.ENTER_FRAME,profilerFrameUpdateHandler);
               var_926 = new Profiler(this);
               attachComponent(var_926,[new IIDProfiler()]);
               var_757 = new ProfilerViewer();
               var_220.addChild(var_757);
               break;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1365);
         if(!_isDisposed)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = var_543[_loc4_] as Array;
      ...
      {
         return var_240 - getNumberOfFilesPending();
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_758)
         {
            ...
            var_758.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
      ...
      private function debugFrameUpdateHandler(param1:Event) : void
      {
         ...
         var _loc3_:uint = _loc2_ - var_282;
         var_282 = _loc2_;
         _loc4_ = 0;
         while(_loc4_ < CoreComponent.const_142)
         {
            var_642[_loc4_] = 0;
            _loc5_ = var_543[_loc4_];
            _loc8_ = 0;
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         var_758 = loadingEventDelegate;
         if(var_281 == null)
         {
            var_281 = new LibraryLoaderQueue(var_681);
         }
         try
         {
            node = config.child(const_1105)[0];
            if(node != null)
            {
               ...
               for each(item in list)
               {
                  ...
                  loader = new ZipLoader(context,true,var_681);
         ...
         {
            error("Failed to parse zip libraries from config xml!",true,Core.const_188,e);
         }
         try
         {
            ...
            if(node != null)
            {
               ...
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_681);
                  assets.loadFromFile(loader,true);
                  loader.load(new URLRequest(url));
                  var_281.push(loader);
                  loader.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,updateLoadingProcess);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_188,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_188,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_188,e);
         }
         if(!disposed)
         {
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_543[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      private function profilerFrameUpdateHandler(param1:Event) : void
      {
         ...
         var msSinceLastUpdate:uint = msCurrentTime - var_282;
         var_282 = msCurrentTime;
         var_926.start();
         criticality = 0;
         while(criticality < CoreComponent.const_142)
         {
            var_642[criticality] = 0;
            receivers = var_543[criticality];
            index = 0;
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_926.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_142)
            {
               _loc2_ = var_543[_loc3_] as Array;
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_758)
         {
            var_758.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_142)
         {
            ...
            {
               if(var_642[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_758)
               {
                  var_758.dispatchEvent(new LibraryProgressEvent(_loc2_.url,var_240 - 0,var_240,_loc2_.elapsedTime));
               }
            }
         }
         if(false)
