package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1638:Point = new Point();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_155);
         var _loc2_:* = !testParamFlag(WindowParam.const_134,WindowParam.const_144);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_351)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_343)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_687 = param1;
         var_583 = !!var_687 ? uint(var_583 | var_1484) : uint(var_583 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2220 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1347:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1300:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_494:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_615:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_80 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_503,this,null));
         }
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_1038);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1131 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_354,this,param1));
         return param1;
      }
      ...
      {
         var_1484 = param1 & 4278190080;
         var_583 = !!var_687 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_79);
      }
            ...
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_286))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  if(testStateFlag(WindowState.const_102))
                  {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_159:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_186,WindowParam.const_155))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_163,WindowParam.const_144))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_509:
                  var_16.invalidate(this,var_8.union(var_56),WindowRedrawFlag.const_399);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1046,this,null));
                     if(var_9 != null)
                     {
               ...
               case WindowNotifyEvent.const_349:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_615,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_247,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_450:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_1039);
                  break;
               case WindowNotifyEvent.const_503:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_247:
                  ...
                  break;
               case WindowNotifyEvent.const_378:
                  var_9.getRegionProperties(null,var_324);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_354:
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1131 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_35 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_450,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_474)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_1050,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_742,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_509,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_159,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_64,true);
         _loc1_.type = WindowNotifyEvent.const_1390;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_169 && var_582 > 0)
         {
            if(!testParamFlag(WindowParam.const_36))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1638,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1638,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1261,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_64,false);
         _loc1_.type = WindowNotifyEvent.const_1235;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_324 = var_9.rectangle.clone();
               var_56.x = var_8.x;
               var_56.y = var_8.y;
               var_56.width = var_8.width;
               var_56.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_416,this,var_9));
            }
            else
            {
               var_324.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_686,properties,var_688.concat(),_id) as WindowController;
         _loc2_.var_582 = var_582;
         _loc2_.var_169 = var_169;
         _loc2_.var_681 = var_681;
         _loc2_.var_324 = var_324.clone();
         ...
         _loc2_.var_1484 = var_1484;
         _loc2_.var_1197 = var_1197;
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_879;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_35 == WindowState.const_449)
         {
            return true;
         }
         var_35 = WindowState.const_449;
         ...
         _loc1_.type = WindowNotifyEvent.const_976;
         update(this,_loc1_);
         dispose();
         return true;
      }
