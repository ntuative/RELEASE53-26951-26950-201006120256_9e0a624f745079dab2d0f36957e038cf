package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_1197:Boolean = true;
      ...
      protected var var_380:Boolean = true;
      ...
      protected var var_424:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         _type = param3;
         _param = param5;
         var_35 = WindowState.const_91;
         var_80 = param4;
         var_688 = param8 == null ? new Array() : param8;
         var_16 = param6;
         var_8 = param7.clone();
