package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_146:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_146 == null || false)
         {
            var_146 = context.create(name + "::submenu","",WindowType.const_448,var_80,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_146.setGlobalRectangle(_loc1_);
         }
         var_146.activate();
         return var_146;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_1030)
         {
            if(param2 == var_146)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_432,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_350,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_575 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_575).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_676)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_574,getSubMenu(),subMenuEventProc);
                  var_676 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_575 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_345,this,null));
         }
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_146 != null)
            {
               _loc2_ = var_146.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_676 = false;
            getTitleText().text = var_575 < var_574.length && var_575 > -1 ? "null" : caption;
         }
      }
   }
}
