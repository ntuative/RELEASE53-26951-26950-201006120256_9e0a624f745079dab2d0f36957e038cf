package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1145:String = "_HEADER";
      
      private static const const_804:String = "margin_right";
      
      private static const const_1146:String = "_SCALER";
      
      private static const const_1066:String = "_TITLE";
      
      private static const const_1147:String = "_CONTENT";
      
      private static const const_803:String = "margin_left";
      
      private static const const_806:String = "margin_bottom";
      ...
      private var var_1400:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_803,_loc3_.left,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_805,_loc3_.top,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_804,0 - _loc3_.right,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_806,0 - _loc3_.bottom,PropertyStruct.const_69,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_286);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_248);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1400 == null)
         {
            var_1400 = findChildByTag(const_1145) as IHeaderWindow;
            if(!var_1400)
            {
      ...
      {
         return findChildByTag(const_1146) as IScalerWindow;
      }
      ...
      {
         return content != null && var_577 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1147) as IWindowContainer;
            if(!var_20)
            {
