package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_989:IItemListWindow;
      
      private var var_386:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_386)
         {
            var_386 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_386)
            {
               var_386.addEventListener(WindowEvent.const_262,scrollBarEventProc);
               var_386.addEventListener(WindowEvent.const_245,scrollBarEventProc);
            }
         }
         return var_386;
      }
      ...
      override public function dispose() : void
      {
         if(var_386)
         {
            var_386.removeEventListener(WindowEvent.const_262,scrollBarEventProc);
            var_386.removeEventListener(WindowEvent.const_245,scrollBarEventProc);
            var_386 = null;
         }
         if(var_989)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_989)
         {
            var_989 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_989;
      }
