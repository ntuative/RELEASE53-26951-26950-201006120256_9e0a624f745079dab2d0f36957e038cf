package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1117:String = "content";
      
      private static const const_1116:String = "selector";
       
      
      private var var_1349:Boolean = false;
      
      protected var var_1013:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1712 == null)
         {
            var_1712 = findChildByTag(TabContextController.const_1117) as IWindowContainer;
         }
         return var_1712;
      }
      ...
      {
         return var_1013.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1013 == null)
         {
            var_1013 = findChildByTag(TabContextController.const_1116) as ITabSelectorWindow;
            if(var_1013 != null)
            {
               var_1013.procedure = selectorEventProc;
            }
         }
         return var_1013;
      }
      ...
      {
         return !!var_909 ? selector.iterator : null;
      }
