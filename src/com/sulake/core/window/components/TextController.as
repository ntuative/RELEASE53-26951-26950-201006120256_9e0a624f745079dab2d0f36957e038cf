package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2483:Rectangle = new Rectangle();
      ...
      protected var var_576:String = "none";
      
      protected var var_682:Number;
      
      protected var var_391:Number;
      ...
      {
         return new Rectangle(var_682 * maxScrollH,var_391 * maxScrollV,width,height);
      }
      ...
      {
         var_682 = param1;
         _field.scrollH = var_682 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_221)
         {
            if(param2.type == WindowNotifyEvent.const_159)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_936,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_487,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_487,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_698,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_698,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_left",var_68.left,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_top",var_68.top,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_right",var_68.right,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_68.bottom,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("auto_size",var_576,PropertyStruct.STRING,var_576 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_698,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_682 = var_682;
         _loc1_.var_391 = var_391;
         _loc1_.var_68 = var_68.clone(_loc1_.setTextMargins);
         _loc1_.var_576 = var_576;
         _loc1_.var_824 = var_824;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_576 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_576 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_576 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_576 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
