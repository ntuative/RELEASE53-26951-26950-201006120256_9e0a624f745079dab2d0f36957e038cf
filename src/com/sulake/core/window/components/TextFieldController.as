package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_909:Boolean = false;
      
      protected var var_1014:uint = 500;
      
      protected var var_1008:Boolean = false;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_1008,PropertyStruct.const_59,var_1008 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_909 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      {
         var _loc2_:* = null;
         InteractiveController.method_5(this,param1);
         for each(_loc2_ in param1)
         {
            if(_loc2_.key == "focus_capturer")
            {
               var_1008 = _loc2_.value as Boolean;
               if(var_1008)
               {
