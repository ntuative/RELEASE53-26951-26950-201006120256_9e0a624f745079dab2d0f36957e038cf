package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_798:uint = 2;
      ...
      private var var_244:Rectangle;
      
      private var var_245:Boolean;
      
      private var var_98:BitmapData;
      
      private var var_1010:Matrix;
      
      private var var_126:WindowRenderer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1039:
               var_776 = var_767.getTheActualState(param1.type,param1.style,param1.state);
               if(var_776 != var_1129)
               {
                  var_245 = true;
                  _loc4_ = true;
         ...
         if(_loc4_)
         {
            var_244.left = Math.min(var_244.left,param2.left);
            var_244.top = Math.min(var_244.top,param2.top);
            var_244.right = Math.max(var_244.right,param2.right);
            var_244.bottom = Math.max(var_244.bottom,param2.bottom);
         }
         return _loc4_;
      }
      ...
      {
         return var_767.getTheActualState(param1.type,param1.style,param1.state) != var_1129;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_798) : uint(const_518);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_776))
            {
               _loc5_ = const_797;
            }
         }
         ...
         if(_loc5_ != const_518)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_797)
               {
                  ...
                  if(var_245)
                  {
                     ...
                     _loc7_.draw(param1,var_98,var_98.rect,var_776,false);
                  ...
                  {
                     var_1010.tx = param2.x;
                     var_1010.ty = param2.y;
                     _colorTransform.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(var_98,var_1010,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
            ...
            var_244.left = int.MAX_VALUE;
            var_244.top = int.MAX_VALUE;
            var_244.right = int.MIN_VALUE;
            var_244.bottom = int.MIN_VALUE;
         }
         return true;
      }
      ...
      {
         var _loc2_:ISkinRenderer = var_767.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_946)
            {
               _loc2_ = var_767.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_946);
            }
         }
         return _loc2_;
      }
