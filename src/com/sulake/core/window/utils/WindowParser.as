package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1512:String = "_INCLUDE";
      
      public static const const_977:String = "_EXCLUDE";
      
      public static const const_1594:String = "_TEMP";
      
      private static const const_1159:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1017:Dictionary;
      
      protected var var_1482:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1483:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1195,var_1196);
         var_1017 = new Dictionary();
         var_1483 = new Dictionary();
         ParamCodeTable.fillTables(var_1017,var_1483);
         var_1482 = new Map();
      }
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1159,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1017)
            {
               delete var_1017[_loc1_];
            }
            for(_loc1_ in var_1483)
            {
               delete var_1483[_loc1_];
            }
            var_1482.dispose();
            var_1482 = null;
            var_16 = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_186)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_977) == -1)
                  {
