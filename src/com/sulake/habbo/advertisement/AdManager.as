   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_430,0,0,_loc4_,var_1543,var_878,var_877));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1903 = _config.getKey("interstitial.enabled","false") == "true";
         var_1904 = int(_config.getKey("interstitial.interval","30000"));
         var_1902 = int(_config.getKey("interstitial.show.time","5000"));
         var_1541 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1266 = _loc2_.imageUrl;
         var_1543 = _loc2_.clickUrl;
         if(var_1266 != "" && var_1543 != "")
         {
            _loc3_ = var_1266;
            ...
            _loc4_ = new URLRequest(var_1266);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_468,0,0,param1.bitmapData,var_1901));
            var_722 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_877 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1541 > 0 && var_1542 >= var_1541)
         {
            return false;
         }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_878 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
