package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1646:PartOffsetData;
      
      private var var_955:AvatarActionManager;
      
      private var var_184:IAssetLibrary;
      
      private var var_954:IAssetLibrary;
      
      private var var_435:AvatarRenderManager;
      
      private var var_326:FigureData;
      ...
      private var var_1645:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_184 = param2;
         var_954 = param3;
         var_326 = new FigureData();
         var_448 = new PartSetsData();
         var_631 = new AnimationData();
         var_1645 = new AvatarStructureDownloadSet();
         var_782 = new AnimationManager();
         var_653 = param4;
         var_1646 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_955.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_653)
         {
            case AvatarType.const_78:
               _loc1_ = var_184.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_448.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_184.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_631.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_184.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_326.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_184.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_448.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_184.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_631.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_184.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_326.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_955.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_326.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_955.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_782.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_448.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1233[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_955.getDefaultAction();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_782.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_326.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_326.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_653 + " ready to go!");
         if(var_653 == AvatarType.const_78)
         {
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_78:
               if(var_184.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_184.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_184.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_184.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_78:
               if(var_184.hasAsset(_loc5_))
               {
                  var_184.removeAsset(var_184.getAssetByName(_loc5_));
               }
               var_1645.add(new AvatarStructureDownload(var_184,_loc5_,var_326));
               break;
            case AvatarType.PET:
         }
         var_1645.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_782.getAnimation(param1);
      }
      ...
      {
         var_955 = new AvatarActionManager(var_184,var_653);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1405 = var_326.getMandatorySetTypeIds();
         return var_1405;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_326.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_954.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_954.getAssetByName("dance" + _loc1_).content as XML;
            var_782.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_954.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_954.getAssetByName("fx" + _loc1_).content as XML;
            var_782.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_326.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_326.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1646.loadOffsets(var_954);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_955.sortActions(param1);
      }
   }
}
