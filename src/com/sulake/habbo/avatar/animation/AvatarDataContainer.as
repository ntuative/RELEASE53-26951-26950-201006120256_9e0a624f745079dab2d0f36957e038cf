package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1570:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1572,var_1571,var_1570,_alphaMultiplier);
         var_1117 = generatePaletteMapForGrayscale(var_2173,var_2172);
      }
