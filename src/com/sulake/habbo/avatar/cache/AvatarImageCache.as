package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1445:int = 60000;
      ...
      private var var_960:IAvatarImage;
      ...
      {
         if(var_591 == param1 || var_591 == GeometryType.const_1006 && param1 == GeometryType.const_907 || param1 == GeometryType.const_1006 && var_591 == GeometryType.const_907)
         {
            var_591 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_626)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_453)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_79.getParts(param1,var_960.getFigure(),_loc6_,var_591,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_79.getCanvas(var_148,var_591);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1291[param1])
            {
            ...
            _loc9_ = var_148 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_148 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_953 || _loc30_ == AvatarAction.const_469) && (_loc6_ == AvatarBodyPartType.const_231 || _loc6_ == AvatarBodyPartType.const_1358 || _loc6_ == AvatarBodyPartType.const_1268) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_148 == AvatarScaleType.const_54)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_128 != null)
         {
            ...
            {
               _loc5_ = var_128.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
