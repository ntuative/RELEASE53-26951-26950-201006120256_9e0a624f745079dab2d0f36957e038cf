package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_1609:BitmapData;
      
      private var var_434:Rectangle;
      ...
      private var var_644:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1608 = Math.max(var_1608,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(var_434 == null)
         {
            if(!analyzePartLayers())
            {
               if(!var_1609)
               {
                  ...
                  var_1609 = _loc9_.content as BitmapData;
               }
               return var_1609;
            }
         }
         ...
         _loc1_ = new BitmapData(var_434.width,var_434.height,true,16777215);
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in _loc8_)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + const_249[_loc6_] + "_" + FigureData.const_110;
            ...
            if(_loc4_)
            {
               ...
               if(var_1607 && _loc2_.colorLayerIndex > 0)
               {
