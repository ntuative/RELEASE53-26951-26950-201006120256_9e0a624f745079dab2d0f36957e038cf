package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1091 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_388 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_388 && var_1091)
         {
            var_388.bitmap = new BitmapData(var_388.width,var_388.height,true,16777215);
            var_388.bitmap.copyPixels(var_1091,var_1091.rect,new Point(0,0 - 0 - 8));
            var_388.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
