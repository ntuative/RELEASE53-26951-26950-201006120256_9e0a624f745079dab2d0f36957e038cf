package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_422:ClubBuyController;
      ...
      private var var_421:ICatalogNavigator;
      ...
      private var var_2011:GiftWrappingConfiguration;
      ...
      private var var_1083:ClubGiftController;
      ...
      {
         return var_359.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2013 && var_522 != null)
         {
            var_522.playSound(HabboSoundTypesEnum.const_988);
         }
         var_2013 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_359.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_84)
         {
            _loc3_ = var_359.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_422 == null)
         {
            var_422 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_96:
               var_1327 = param1.session.isPrivateRoom;
               if(var_86 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2011 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_909)
         {
            if(!var_359.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_236,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1083.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_421 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1083 == null)
         {
            var_1083 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_422.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_421.buildCatalogIndex(_loc2_);
         if(var_1084 != "")
         {
            var_421.openPage(var_1084);
            var_1084 = "";
         }
         else
         {
            var_421.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_316 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_316.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_316.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2012 && var_522 != null)
         {
            var_522.playSound(HabboSoundTypesEnum.const_926);
         }
         var_2012 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_316.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_316.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_316 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_316.habboCatalog = this;
      }
