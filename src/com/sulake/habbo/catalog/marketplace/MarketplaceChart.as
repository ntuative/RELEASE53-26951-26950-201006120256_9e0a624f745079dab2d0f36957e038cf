package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1020 + var_1020 / -var_2484 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_836 - var_836 / var_400 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_400).toString().length - 1);
         var_400 = Math.ceil(var_400 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_400.toString();
         _loc3_.draw(_loc6_);
         var_1020 = param1 - _loc6_.textWidth - 2;
         var_836 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_836);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_836 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1020 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1020,(param2 - var_836) / 2));
         return _loc3_;
      }
