package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2492:String = "magic.pixels";
      
      private var var_2493:String = "catalog.page.club";
      
      private var var_2525:String = "magic.credits";
      ...
      {
         _catalog.openCatalogPage(var_2493,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_296.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_296)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_296.indexOf(_loc6_);
            var_296.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
