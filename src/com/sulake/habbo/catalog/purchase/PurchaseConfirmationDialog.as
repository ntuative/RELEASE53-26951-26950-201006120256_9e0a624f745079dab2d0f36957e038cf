package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1443:uint = 4.294967295E9;
      
      private const const_1444:uint = 4.293848814E9;
      
      private var var_974:int;
      
      private const const_1739:uint = 4.291613146E9;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_249.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_975;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_975,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1444) : uint(const_1443);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_446,var_77,var_1151);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_249.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_292) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_975);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_667[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_668[var_211]);
         _catalog.purchaseProductAsGift(var_446,var_77,var_1151,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_127:
               ...
               if(var_2308 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_255)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1738)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2308 = _loc3_.text;
               break;
            case WindowMouseEvent.const_55:
               showSuggestions(false);
               if(var_1425)
               ...
               break;
            case WindowKeyboardEvent.const_685:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_292 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_292 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1637 = _loc1_.stuffTypes;
            var_667 = _loc1_.boxTypes;
            var_668 = _loc1_.ribbonTypes;
            var_975 = var_1637[0];
            _boxIndex = var_667[0];
            var_211 = var_668[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_249.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_292) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_292);
         }
         var_292 = param1;
         if(var_292 < 0)
         {
            var_292 = _loc2_.numListItems - 1;
         }
         if(var_292 >= _loc2_.numListItems)
         {
            var_292 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_292) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_249 == null)
         {
            var_249 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_556 == null)
         {
            var_556 = createWindow("suggestion_list_item") as IWindowContainer;
            var_556.procedure = suggestionsEventHandler;
         }
         if(var_249 == null || var_556 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_249.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_556.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
