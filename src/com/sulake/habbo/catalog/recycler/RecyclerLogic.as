package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_810:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1663)
         {
            case RecyclerStatusMessageEvent.const_1289:
               var_288 = const_372;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_955:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1663 != RecyclerStatusMessageEvent.const_955;
      }
      
      private function get statusActive() : Boolean
      {
         return var_288 != const_810;
      }
      ...
      {
         return active && var_288 == const_372;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_180)
            {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_906:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1225:
