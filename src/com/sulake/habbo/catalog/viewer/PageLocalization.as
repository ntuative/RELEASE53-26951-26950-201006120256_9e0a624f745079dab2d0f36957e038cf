package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_157:Dictionary = new Dictionary();
      
      private static const const_782:Object = {"frontpage3":[7,8]};
      
      private static const const_1095:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_783:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1094:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_157["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_157["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_157["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_157["collectibles"] = ["ctlg_collectibles_link"];
         const_157["club1"] = ["ctlg_text_5"];
         const_157["club_buy"] = ["club_link"];
      }
