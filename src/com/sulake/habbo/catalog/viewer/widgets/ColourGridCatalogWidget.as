package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var_308 = null;
         for each(_loc1_ in var_1309)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1308) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_937.width,var_937.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_765.width,var_765.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_765,var_765.rect,new Point(0,0),null,null,true);
