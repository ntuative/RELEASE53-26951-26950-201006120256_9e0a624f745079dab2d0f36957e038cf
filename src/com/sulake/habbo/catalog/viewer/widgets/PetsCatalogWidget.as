package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_403 >= var_306.length)
         {
            return "";
         }
         var petColor:IPetColor = var_306[var_403] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_594[var_1510] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_403 = param1.index;
         if(var_403 < 0 || var_403 > var_306.length)
         {
            var_403 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_608.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_127,onTextWindowEvent);
         var_608 = new Map();
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_608.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_403 >= 0 && var_403 < var_306.length)
         {
            _loc7_ = var_306[var_403] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_594[var_1510] as IBreed;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_846,_loc3_.id,_loc2_,AvatarScaleType.const_54,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_276,AvatarAction.const_535);
