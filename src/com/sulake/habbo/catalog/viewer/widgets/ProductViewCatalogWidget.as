package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1364:IScrollbarWindow;
      
      protected var var_1439:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_1364 != null)
         {
            var_1364.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1242.text = "${" + _loc3_.name + "}";
            var_1243.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1242.text = "${" + _loc2_.localizationId + "}";
            var_1243.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_400:
                  _loc4_ = var_1365.clone();
                  if(var_641 != null)
                  {
                     var_641.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_641,var_1364,var_1439);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_230:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_276,AvatarAction.const_426);
                              _loc13_.appendAction(AvatarAction.const_512,_loc6_.productClassId);
