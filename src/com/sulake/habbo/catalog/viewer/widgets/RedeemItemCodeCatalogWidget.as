package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1041 != null)
         {
            var_1041.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1042 != null)
         {
            var_1042.removeEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1041 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1041 != null)
         {
            var_1041.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1042 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1042 != null)
         {
            var_1042.addEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         }
      }
