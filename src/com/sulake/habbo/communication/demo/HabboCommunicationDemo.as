package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2381:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1704:ILogger;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2382)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_823 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_823);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1468,var_2380));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1453,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2381);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1453,"/");
      ...
      {
         var_823 = _habboConfiguration.getKey("sso.ticket",null);
         var_1468 = _habboConfiguration.getKey("flash.client.url","");
         var_2380 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_189 == null)
         {
         ...
         if(var_823 != null)
         {
            var_62.mode = HabboConnectionType.const_452;
            var_62.initConnection(HabboConnectionType.const_289);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1704 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2381 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_62.mode)
         {
            case HabboConnectionType.const_452:
               _loc6_ = "";
               ...
               var_1183 = _loc4_;
               var_189.loadBannerImage(_loc7_ + "?token=" + var_1183,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_914:
               sendConnectionParameters(_loc2_);
               break;
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1183);
         ...
         while(_loc13_ > 0)
         {
            ...
            var_470.init(_loc14_);
            _loc15_ = var_470.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_62.mode = HabboConnectionType.const_914;
            }
         }
         var_62.initConnection(HabboConnectionType.const_289);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_243);
      }
