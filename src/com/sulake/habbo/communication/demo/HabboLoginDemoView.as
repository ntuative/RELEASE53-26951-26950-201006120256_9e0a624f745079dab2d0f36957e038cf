package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private const const_1453:String = "fuselogin";
      
      public var name:String = "";
      
      private var _window:IWindowContainer;
      
      private var var_179:HabboCommunicationDemo;
      ...
      {
         var_179.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_179.shockwaveClientUrl = var_115.shockwaveClientUrl;
         var_179.ssoTicket = var_115.ticket;
         var_115.removeEventListener(SSOTicket.const_347,onParsedTicketSuccess);
         var_115.removeEventListener(SSOTicket.const_272,onParsedTicketFailure);
         var_115 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1453,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_179 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_179.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_110,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_179.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1453,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_179.habboConfiguration.getKey("use.sso","false") == "true")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_179.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_179.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_179.habboCommunication.habboWebLogin(name,password);
         var_115 = new SSOTicket(var_179.assets,_loc2_,_loc1_);
         var_115.addEventListener(SSOTicket.const_347,onParsedTicketSuccess);
         var_115.addEventListener(SSOTicket.const_272,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_179.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_179.windowManager.buildFromXML(_loc3_.content as XML);
