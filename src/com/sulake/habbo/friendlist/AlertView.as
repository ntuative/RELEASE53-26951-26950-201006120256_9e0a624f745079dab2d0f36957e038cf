package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1589:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1350));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1589[var_1350]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
