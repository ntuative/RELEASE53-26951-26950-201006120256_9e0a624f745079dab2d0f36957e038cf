package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1404:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1404 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_835 = IWindowContainer(var_15.content.findChildByName("main_content"));
         var_297 = IWindowContainer(var_15.content.findChildByName("footer"));
         var_1404.prepare(var_835);
         var_15.procedure = onWindow;
         var_15.content.setParamFlag(HabboWindowParam.const_937,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1429,true);
         var_15.header.setParamFlag(HabboWindowParam.const_634,false);
         var_15.header.setParamFlag(HabboWindowParam.const_916,true);
         var_15.content.setParamFlag(HabboWindowParam.const_634,false);
         var_15.content.setParamFlag(HabboWindowParam.const_916,true);
         var_15.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1403 = ITextWindow(var_15.findChildByName("info_text"));
         var_1403.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_297.y = Util.getLowestPoint(var_15.content);
         ...
         var_15.scaler.setParamFlag(HabboWindowParam.const_938,this._friendList.tabs.findSelectedTab() != null);
         var_15.scaler.setParamFlag(HabboWindowParam.const_634,false);
         var_15.scaler.setParamFlag(HabboWindowParam.const_937,false);
         var_15.scaler.x = 0 - var_15.scaler.width;
         var_15.scaler.y = 0 - var_15.scaler.height;
         var_1643 = var_15.height;
         var_1642 = var_15.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1643 == -1 ? 0 : int(0 - var_1643);
         var _loc4_:int = var_1642 == -1 ? 0 : int(0 - var_1642);
