package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1451:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_338 && _loc4_.state != FriendRequest.const_330)
            {
      ...
      {
         var_1554 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1555 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1555.procedure = onDismissAllButtonClick;
         var_1554.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_338 && _loc4_.state != FriendRequest.const_330)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_274,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_154)
         {
         ...
         else if(param1.state == FriendRequest.const_1017)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1554,_loc1_);
         setEnabled(var_1555,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_274,param1));
         }
      }
   }
}
