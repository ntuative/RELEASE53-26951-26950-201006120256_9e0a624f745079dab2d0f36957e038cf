package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2373:IContainerButtonWindow;
      
      private var var_2374:IContainerButtonWindow;
      
      private var var_2376:IContainerButtonWindow;
      
      private var var_2375:IContainerButtonWindow;
      ...
      {
         var_2374 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2376 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2373 = initButton("room_invite",onInviteButtonClick,param1);
         var_2375 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2374,isEnableMinimailButton(_loc1_));
         setEnabled(var_2376,isEnableHomeButton(_loc1_));
         setEnabled(var_2373,isEnableInviteButton(_loc1_));
         setEnabled(var_2375,isEnableRemoveButton(_loc1_));
      }
