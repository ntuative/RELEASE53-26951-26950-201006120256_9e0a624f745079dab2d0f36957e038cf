package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1528:OpenedToWebPopup;
      
      private var var_866:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_440:FriendListTabs;
      ...
      private var var_1527:AvatarSearchResults;
      ...
      private var var_1833:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_867:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1833 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1527 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_348.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_348.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_440.findTab(FriendListTab.const_90).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_348 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_91.addCategory(new FriendCategory(FriendCategory.const_939,getText("friendlist.friends")));
         var_91.addCategory(new FriendCategory(FriendCategory.const_398,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_91.addFriend(new Friend(_loc4_));
         }
         var_440 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_496)
         {
            var_496 = new Timer(120000);
            var_496.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_496.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_496.stop();
            var_496.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_496 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_867)
         {
            var_867.release(new IIDHabboNotifications());
            var_867 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_602)
         {
            var_602.release(new IIDSessionDataManager());
            var_602 = null;
         }
         super.dispose();
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_440.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_308));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1527.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_348.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_602.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_602.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_348.limit)
         {
            var_348.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_440.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_866.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_348.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_440.findTab(FriendListTab.const_90);
      ...
      {
         var_867 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1528 == null)
         {
            var_1528 = new OpenedToWebPopup(this);
         }
         var_1528.show(x,y);
      }
