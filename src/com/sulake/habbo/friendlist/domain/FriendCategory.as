package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_357:int = 100;
      ...
      {
         return Math.ceil(this.var_255.length / const_357);
      }
      ...
      {
         if(this.var_1001 >= this.getPageCount())
         {
            this.var_1001 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return this.var_1001 * const_357;
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         while(_loc3_ < var_255.length)
         {
            ...
            {
               var_255.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_1001 + 1) * const_357,this.var_255.length);
      }
