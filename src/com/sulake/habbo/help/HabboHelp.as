package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_2034:UserRegistry;
      ...
      private var var_914:FaqIndex;
      
      private var var_1882:String = "";
      
      private var var_1140:IncomingMessages;
      
      private var var_1345:CallForHelpData;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1345 = new CallForHelpData();
         var_2034 = new UserRegistry();
         super(param1,param2,param3);
         _assetLibrary = param3;
         var_914 = new FaqIndex();
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_57 = new HelpUI(this,_assetLibrary,_windowManager,var_746,_toolbar);
         }
         return var_57 != null;
      }
      ...
      {
         var_1345.reportedUserId = param1;
         var_1345.reportedUserName = param2;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1140 = new IncomingMessages(this,var_314);
