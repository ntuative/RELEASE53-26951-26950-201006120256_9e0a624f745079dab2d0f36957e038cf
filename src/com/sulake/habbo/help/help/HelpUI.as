package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2289:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26951-26950-201006120243");
         _toolbar = param5;
         var_111 = new Map();
         var_111.add(HabboHelpViewEnum.const_1337,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_149,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_485,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_293,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_228,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_558,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_339,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_613,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_202,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_111.add(HabboHelpViewEnum.const_864,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_569,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1664 = 0 - _loc3_.width;
         var_1665 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_289 == HabboHelpViewEnum.const_149 || false)
         {
            return;
         }
         if(var_452 == null)
         {
            ...
            var_452 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_452 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_452 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_452 as IWindow);
      ...
      {
         return var_111.getValue(var_289);
      }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_202:
               ...
               break;
            case CallForHelpResultEnum.const_834:
      ...
      {
         var _loc3_:* = null;
         if(var_289 == HabboHelpViewEnum.const_149)
         {
            return;
         }
         if(true)
         {
            ...
            var_662.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_662.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_452.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_662[1],var_662[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_662[0],var_662[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1665;
         _window.width = _loc1_.width + var_1664;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_289);
            return;
         }
         ...
         if(_loc3_)
         {
            if(_toolbar != null)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_403));
      }
