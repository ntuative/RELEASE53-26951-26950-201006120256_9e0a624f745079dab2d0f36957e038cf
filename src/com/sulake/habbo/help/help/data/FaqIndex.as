package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_699:FaqCategory;
      
      private var var_698:FaqCategory;
      ...
      {
         super();
         var_698 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_699 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_127 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_698.hasItem(param1))
         {
            var_698.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_699.hasItem(param1))
         {
            var_699.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
