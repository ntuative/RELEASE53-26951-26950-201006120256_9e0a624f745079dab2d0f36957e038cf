package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_375:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_403,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_478,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_376,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_113));
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1025 = param2;
         var_1026 = param3;
         if(var_33 == null || var_33.id == const_86)
         {
            prepareForTutorial();
            showView(const_86);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_33 != null && (var_33.id == const_225 || var_33.id == const_86))
         {
            showView(const_86);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1665;
         _window.width = _loc2_.width + var_1664;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function method_6(param1:ChangeUserNameResultMessageEvent) : void
      {
         if(param1 == null)
         {
            return;
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_403,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_478,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_376,onTaskDoneEvent);
            _main = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_403:
               var_1026 = true;
               if(var_33 != null && var_33.id == const_375)
               {
                  showView(const_86);
               }
               break;
            case HabboHelpTutorialEvent.const_478:
               if(var_33 != null && var_33.id == const_335)
               {
                  var_1210 = true;
                  disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_376:
               if(var_1210)
               {
                  var_1210 = false;
                  showView(const_86);
      ...
      {
         var_1027 = true;
         if(var_33 != null && (var_33.id == const_335 || var_33.id == const_86))
         {
            showView(const_86);
         }
      }
      ...
      {
         return var_1027 && var_1025 && var_1026;
      }
   }
}
