package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1737:int = 500;
      ...
      private var var_1140:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_447,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_620));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_48.getValue(InventoryCategory.const_80));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_992));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1737);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_355));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_958.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_958.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_280));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_359 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_958.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_48.getValue(InventoryCategory.const_341) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1140 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_259));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_447,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_341,_loc3_);
         ...
         var_48.add(InventoryCategory.const_80,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_359);
         var_48.add(InventoryCategory.const_259,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_48.add(InventoryCategory.const_620,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_359);
         var_48.add(InventoryCategory.const_355,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_48.add(InventorySubCategory.const_280,_loc8_);
