package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1089:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1090 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_1090.procedure = inactiveGridEventProc;
         var_1089 = _view.findChildByName("active_items") as IItemGridWindow;
         var_1089.procedure = activeGridEventProc;
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_1089.getGridItemIndex(param1.window);
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            var_1089.addGridItem(_loc2_.window);
