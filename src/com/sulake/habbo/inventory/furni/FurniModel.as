package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_238,onObjectPlaced);
         var_538 = new Timer(const_1101,1);
         var_538.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_238,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_538 != null)
            {
               var_538.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_538.stop();
               var_538 = null;
            }
            if(var_138 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_756 == null)
         {
            var_756 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_756.clone() as IWindowContainer;
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_341);
         ...
         if(param1 == InventoryCategory.const_80 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_310:
                  _controller.toggleInventoryPage(InventoryCategory.const_145);
            }
         }
      }
      ...
      {
         if(var_924 && param1.type == RoomEngineObjectEvent.const_238)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_319 || _loc3_.category == FurniCategory.const_329)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_430 = new Map();
         var_430.add(const_44,new Array());
         var_430.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
