package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2410:BitmapData;
      ...
      private const const_1456:Number = 0.2;
      
      protected var var_1477:Boolean;
      
      private const const_1455:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_690)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1654));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1478);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1456;
               _loc1_.blend = const_1456;
            }
            else
            {
               _window.blend = const_1455;
               _loc1_.blend = const_1455;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1477 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2410;
               _loc5_.visible = true;
            }
            else
            {
