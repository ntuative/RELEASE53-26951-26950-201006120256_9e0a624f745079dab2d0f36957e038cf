package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1467 && param1.type == RoomEngineObjectEvent.const_238)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1467 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_209,_loc3_.figure);
      ...
      {
         if(var_1056.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
