package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_674:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_337:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_876,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_674.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_674.setSelected(_loc2_);
            var_337.openMessenger();
            var_337.refresh(true);
         }
      }
      ...
      {
         var_674.addMessageAndUpdateView(param1);
         if(!var_337.isMessengerOpen())
         {
      ...
      {
         var_674 = new Conversations(new ConversationsDeps(this));
         var_337 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_674.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_674.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_882,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_674.addMessageAndUpdateView(_loc3_);
      }
