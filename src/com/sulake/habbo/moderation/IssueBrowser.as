package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1715:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1716:String = "picked_issues";
      ...
      private var var_1556:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_360.view.width = var_233.container.width;
         var_360.view.height = var_233.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1717:
               if(var_1558 == null)
               {
                  var_1558 = new MyIssuesView(issueManager,this,var_233.container);
               }
               return var_1558;
            case const_1715:
               if(var_1557 == null)
               {
                  var_1557 = new OpenIssuesView(issueManager,this,var_233.container);
               }
               return var_1557;
            case const_1716:
               if(var_1556 == null)
               {
                  var_1556 = new PickedIssuesView(issueManager,this,var_233.container);
               }
               return var_1556;
            default:
               return null;
