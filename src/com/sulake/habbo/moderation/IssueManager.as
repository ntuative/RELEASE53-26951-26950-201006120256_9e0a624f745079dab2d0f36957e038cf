package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1041:String = "issue_bundle_open";
      
      public static const const_538:String = "issue_bundle_my";
      
      public static const const_871:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_143 = new Map();
         var_971 = new Map();
         var_664 = new IssueBrowser(this,var_61.windowManager,var_61.assets);
         var_796 = [];
         var_972 = [];
         var_1149 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1149.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in var_143)
         {
            ...
            {
               case const_1041:
                  if(_loc4_.state == IssueMessageData.const_154)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_538:
                  if(_loc4_.state == IssueMessageData.const_495 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_971.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_971.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1189)
         {
            var_158.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_143)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_971.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_971.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_154)
         {
            _loc5_ = getBundles(const_538);
            _loc6_ = false;
            ...
            _loc8_ = var_972.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1149.remove(param1);
         var_1149.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_495 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1149.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_154 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_664 == null || !var_664.isOpen())
         {
            var_61.soundManager.playSound(HabboSoundTypesEnum.const_917);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_971.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_143.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_495 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
