package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_737:OffenceCategoryData;
      ...
      private var var_902:IDropMenuWindow;
      
      private var var_55:IFrameWindow;
      
      private var var_738:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_903 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_902.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1319,var_419.text,getBanLength(),var_1318));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_902.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1319,var_419.text,var_1318));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_737 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1319,var_419.text,var_1318));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_737 != null;
         if(this.var_738 != null)
         {
            var_55.findChildByName("offence_txt").caption = this.var_738.name;
            var_55.findChildByName("offence_category").visible = true;
         }
         else if(this.var_737 != null)
         {
            this.refreshButtons("offences_cont",2,var_737.offences,var_904,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_903,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_738 = var_737.offences[_loc3_];
         var_419.text = var_738.msg;
         var_328 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_55.caption = "Mod action on: " + var_1578;
         ...
         var_902 = IDropMenuWindow(var_55.findChildByName("banLengthSelect"));
         prepareBanSelect(var_902);
