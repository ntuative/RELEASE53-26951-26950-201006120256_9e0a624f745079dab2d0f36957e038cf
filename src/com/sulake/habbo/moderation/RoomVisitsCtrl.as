package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1768:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1768.clone());
      ...
      {
         var_1768 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
