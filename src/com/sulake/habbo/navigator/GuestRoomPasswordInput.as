package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomPasswordInput
   {
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:IButtonWindow = _window.findChildByName("com.sulake.habbo.communication.messages.parser.tracking") as IButtonWindow;
         if(_loc2_ != null)
         {
      ...
      private function onTry(param1:WindowMouseEvent) : void
      {
         ...
         _navigator.goToRoom(var_888.flatId,true,_loc3_);
         hide();
      }
