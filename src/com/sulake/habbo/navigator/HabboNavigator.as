package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2524:Dictionary;
      ...
      private var var_984:RoomCreateViewCtrl;
      
      private var var_1745:RoomThumbnailRenderer;
      
      private var _toolbar:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_563:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_440:Tabs;
      
      private var var_295:MainViewCtrl;
      
      private var var_2323:Array;
      
      private var var_1065:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_295 = new MainViewCtrl(this);
         var_563 = new RoomInfoViewCtrl(this);
         var_984 = new RoomCreateViewCtrl(this);
         var_1745 = new RoomThumbnailRenderer(this);
         var_1065 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_440 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_295.startSearch(Tabs.const_203,Tabs.const_323,param1);
         var_295.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_563.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_295.startSearch(Tabs.const_285,Tabs.const_223);
         var_440.getTab(Tabs.const_285).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_295.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
