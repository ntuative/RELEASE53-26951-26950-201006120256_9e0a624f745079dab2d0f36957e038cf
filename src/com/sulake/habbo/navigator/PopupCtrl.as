package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_346.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_346)
         {
            var_346.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_346.reset();
            var_346 = null;
         }
         if(var_302)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_49 == null)
         {
            var_49 = IWindowContainer(_navigator.getXmlWindow(var_1350));
            var_49.visible = false;
         ...
         var_49.x = _loc2_.x + var_1719 + param1.width;
