package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1745 = new RoomThumbnailRenderer(param1);
         var_938 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_172,var_113.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_938.refreshTags(_loc1_,var_113.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1745.refreshThumbnail(_loc1_,var_113.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_172,var_113);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_172,!true ? getEventCtg(var_113.categoryId) : getRoomCtg(var_113.categoryId));
         refreshRoomDesc(var_172,var_113);
         refreshExtraCont();
         refreshInfo(var_172,"trading_allowed",var_113.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_203,Tabs.const_242,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
