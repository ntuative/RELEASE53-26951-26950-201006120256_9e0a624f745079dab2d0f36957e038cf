package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_391:IScrollbarWindow;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1395 != null)
         {
            _loc2_ = var_1395.tags[0];
            var_1395.color = getBgColor(_loc2_);
         }
         var_1395 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_391 = IScrollbarWindow(var_20.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_2208 - _loc2_.stageX);
         var_2208 = _loc2_.stageX;
         var_2207 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_187,null,0);
         ...
         var_947.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_122:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_187:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1415,true);
