package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1166:int = 267;
      
      private static const const_1167:int = 65;
      
      private static const const_1165:int = -70;
       
      
      private var var_2341:PublicRoomThumbs;
      
      private var var_20:IWindowContainer;
      
      private var _navigator:HabboNavigator;
      
      private var var_947:UserCountRenderer;
      
      private var var_50:IItemListWindow;
      
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         var_2341 = new PublicRoomThumbs();
         super();
         _navigator = param1;
         var_947 = new UserCountRenderer(_navigator);
      }
      ...
      {
         var _loc4_:String = var_2341.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1165) : 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1418)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1167) : int(const_1166);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_692 || param2.type == OfficialRoomEntryData.const_631))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_947.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_203,Tabs.const_323,_loc2_.tag);
         }
