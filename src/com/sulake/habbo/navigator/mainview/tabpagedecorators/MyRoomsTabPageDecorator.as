package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_535:IDropMenuWindow;
      
      private var var_2512:IWindowContainer;
      ...
      {
         var _loc1_:int = var_535 == null ? 0 : int(var_535.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_285,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_535 == null)
         {
            var_535 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_535.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
