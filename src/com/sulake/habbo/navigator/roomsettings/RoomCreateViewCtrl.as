package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         var_39 = new Array();
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
      ...
      private function prepare() : void
      {
         ...
         var_1039 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         var_1039.goBackToInitialState();
         var_1039.input.textBackgroundColor = 4294967295;
         var_853 = var_39[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_42,HabboWindowParam.const_70,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1039.getText();
      ...
      {
         var _loc1_:Boolean = var_1039.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
