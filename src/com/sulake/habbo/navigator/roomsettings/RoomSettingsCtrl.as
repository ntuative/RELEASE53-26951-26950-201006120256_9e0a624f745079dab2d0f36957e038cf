package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1275:TextFieldManager;
      ...
      private var var_1909:ITextWindow;
      
      private var var_416:IRoomSettingsCtrlOwner;
      ...
      private var var_1274:ICheckBoxWindow;
      ...
      private var var_1065:TextFieldManager;
      ...
      public function onFlatControllerRemoved(param1:int, param2:int) : void
      {
         ...
         if(var_516)
         {
            this.var_416.roomSettingsRefreshNeeded();
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1065.clearErrors();
         this.var_1275.clearErrors();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_416.roomSettingsRefreshNeeded();
      ...
      {
         if(param1 != this.var_415 || var_1067 < 1)
         {
            return;
         }
         var_1067 = 0;
         ...
         {
            this.var_881.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1377)
         {
            this.var_881.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         {
            this.var_1065.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_881.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function populateForm() : void
      {
         ...
         {
            case RoomSettingsData.const_187:
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_56,HabboWindowStyle.const_42,HabboWindowParam.const_70,new Rectangle(0,0,100,20)));
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_187;
               break;
         ...
         {
            _loc8_ = var_1065.getText();
            _loc9_ = var_1275.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1065.clearErrors();
               this.var_1275.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1276.isSelected;
         _loc2_.allowFoodConsume = var_1274.isSelected;
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1550.visible = _inRoom;
         var_1552.visible = _inRoom;
         var_1908.visible = var_516;
         var_1909.visible = !var_516;
         if(var_516)
         {
            var_1066.visible = true;
            var_1278.visible = false;
            refreshFlatControllers();
            var_1066.height = Util.getLowestPoint(this.var_1066) + 4;
         }
         else
         {
            populateForm();
            var_1068.visible = true;
            var_1278.visible = true;
            ...
            var_1068.height = Util.getLowestPoint(this.var_1068) + 4;
         }
         var_1551.text = !!var_516 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1550.name,var_1277.name,var_1068.name,var_1066.name,var_1278.name,var_1552.name],0,0);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_641,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_854,onDoorModePasswordUnselect);
         ...
         this.var_881 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1279 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_908 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_907 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1065 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1275 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1276 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1274 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         ...
         var_1550 = IWindowContainer(_window.findChildByName("header_container"));
         var_1277 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1068 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1066 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1552 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1278 = IWindowContainer(_window.findChildByName("footer_container"));
         var_267 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1069 = IWindowContainer(_window.findChildByName("password_container"));
         var_1909 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1908 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1551 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1551.procedure = onSwitchView;
         var_1069.visible = false;
         if(!_inRoom)
         {
