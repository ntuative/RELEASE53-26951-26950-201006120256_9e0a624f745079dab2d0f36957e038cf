package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2244:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1650,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1649,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1650 = IButtonWindow(find("top_tab"));
         var_1649 = IButtonWindow(find("obj_tab"));
         var_2245 = IWindowContainer(find("tile_grid"));
         var_2244 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1650,onTopTabButton);
         Util.setProcDirectly(var_1649,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2245;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2244;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_42,HabboWindowParam.const_70,new Rectangle(0,0,param1.width,66)));
