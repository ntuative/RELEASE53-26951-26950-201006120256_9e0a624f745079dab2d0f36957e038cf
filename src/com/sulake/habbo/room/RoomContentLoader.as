package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_786:String = "selection_arrow";
      
      private static const const_787:String = "tile_cursor";
      
      private static const const_298:String = "RCL_PUBLICROOM_";
      
      private static const const_517:String = "wall_place_holder";
      
      private static const name_2:int = 2;
      
      private static const const_367:String = "place_holder";
      
      private static const const_1097:String = const_367;
      ...
      public static const const_717:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_523 = [];
         _wallItems = [];
         var_2023 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2021 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_316,_loc4_);
      ...
      {
         var _loc2_:String = var_525.getValue(param1) as String;
         return getObjectColorIndex(_loc2_);
      }
      
      public function hasInternalContent(param1:String) : Boolean
      {
         if(param1 == RoomObjectVisualizationEnum.const_152 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_298 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_359.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_180 != null && var_180.hasWorldType(const_298 + param1))
         {
            return var_180.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_365 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_365.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_634.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_367,const_517,ROOM_CONTENT,const_787,const_786];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_34 || _loc2_ == RoomObjectCategoryEnum.const_32)
         {
            ...
            return int(var_524.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2023.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_182 && _loc5_ != RoomObjectLogicEnum.const_152)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_526.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_635.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2021.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_316,_loc5_);
         }
         else
         {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1252);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_525.getValue(param1) as String;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_270;
         }
         return RoomObjectCategoryEnum.const_210;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2022)
         {
            ...
            if(var_1086 != null)
            {
               var_1086.dispatchEvent(new Event(const_717));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_180 != null)
         {
            return var_180.getWorldHeightScale(const_298 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_635.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_526.add(_loc3_,_loc4_);
               if(var_523.indexOf(_loc7_) < 0)
               {
                  var_523.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               var_525.add(_loc3_,_loc4_);
               if(_wallItems.indexOf(_loc7_) < 0)
               {
                  _wallItems.push(_loc7_);
               }
            }
            _loc8_ = var_524.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_524.remove(_loc7_);
               var_524.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1086 = param1;
         var_2024 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_2020 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_2026 = param2.getKey("public.room.dynamic.download.url","");
         var_2025 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_35 = const_788;
         initFurniData();
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_365.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_182 && _loc5_ != RoomObjectVisualizationEnum.const_152)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_298 + param1) == RoomObjectCategoryEnum.const_66)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_180 = var_1332.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_180 != null)
         {
            return var_180.getWorldScale(const_298 + param1);
         }
         return 32;
      }
   }
