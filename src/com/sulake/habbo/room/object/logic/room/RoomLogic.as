   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_729,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_617,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_737,1);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1003,int(param1.bgOnly));
         var_1204 = _color;
         var_1488 = var_1227;
         var_1019 = _loc3_;
         var_1489 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_900:
               param2.setNumber(RoomObjectVariableEnum.const_617,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1043:
               param2.setNumber(RoomObjectVariableEnum.const_737,_loc3_);
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_427:
               ...
               var_453.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_766:
               _loc4_ = var_453.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_453.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1019,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_709:
            ...
            case RoomObjectRoomUpdateMessage.const_675:
               param2.setString(RoomObjectVariableEnum.const_752,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_832)
         {
            ...
            {
               _loc7_ = var_1204 >> 16 & 255;
               _loc8_ = var_1204 >> 8 & 255;
               _loc9_ = var_1204 & 255;
               _loc10_ = var_1019 >> 16 & 255;
               _loc11_ = var_1019 >> 8 & 255;
               _loc12_ = var_1019 & 255;
               _loc13_ = (_loc2_ - var_832) / var_1490;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1488 + (var_1489 - var_1488) * _loc13_;
               _color = _loc3_;
               var_1227 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_729,_loc3_);
         }
      }
      ...
      override public function method_1(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1344,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1182,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1177,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_193)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_148 || _loc13_ == RoomPlaneData.const_288)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
