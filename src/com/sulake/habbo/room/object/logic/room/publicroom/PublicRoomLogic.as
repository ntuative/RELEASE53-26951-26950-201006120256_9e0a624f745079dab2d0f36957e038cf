package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_646,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1024:
                  _loc2_.setString(RoomObjectVariableEnum.const_346,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_646,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_435,Number(true));
                  var_1152 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_911);
            }
         }
      }
      ...
      override public function method_1(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_507)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_646);
