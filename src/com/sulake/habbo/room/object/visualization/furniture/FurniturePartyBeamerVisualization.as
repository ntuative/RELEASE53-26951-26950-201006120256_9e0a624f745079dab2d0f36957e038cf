package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_795:int = 15;
      
      private static const const_1126:int = 2;
      
      private static const const_371:int = 2;
      
      private static const const_794:int = 31;
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1125 = new Array();
         var_1125.push(Math.random() * _loc2_ * 1.5);
         var_1125.push(Math.random() * _loc2_ * 1.5);
         var_1126 = new Array();
         var_1126.push(1);
         var_1126.push(-1);
         var_1124 = new Array();
         var_1124.push(const_1126);
         var_1124.push(const_1127);
         var_1127 = new Array();
