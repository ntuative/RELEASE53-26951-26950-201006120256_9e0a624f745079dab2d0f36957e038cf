package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_342:int = 1000;
      ...
      private var var_544:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_544 = var_284.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_544 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_284 != null)
         {
            ...
            {
               _loc1_ = var_284.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_284.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_284.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
