package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1238:int = 360;
      
      private var var_1802:int = 0;
      
      private var var_707:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1238 / 2) % 360 / var_1238;
         ...
         {
            _loc6_ = int(var_224.getKey(_loc5_)) * var_1238;
