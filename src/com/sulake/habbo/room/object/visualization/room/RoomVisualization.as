package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_815:int = 16777215;
      
      public static const const_1392:int = 10066329;
      
      private static const const_817:int = 13421772;
      
      public static const const_1288:int = 16777215;
      
      public static const const_1373:int = 16777215;
      
      private static const const_816:int = 10066329;
      
      private static const const_818:int = 10066329;
      ...
      private var var_1445:String = null;
      
      private var var_2313:int = 255;
      ...
      private var var_1444:String = null;
      
      private var var_2157:int = -1000;
      
      private var var_1154:uint = 16777215;
      ...
      private var var_670:Rectangle = null;
      ...
      private var var_2310:String = null;
      ...
      private var var_453:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_453 = new RoomPlaneBitmapMaskParser();
         var_332["null"] = false;
         var_332["null"] = true;
         var_332["null"] = true;
         var_332["null"] = true;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1035);
         var _loc7_:int = 0;
         while(_loc7_ < var_88.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_148)
            {
               ...
               {
                  _loc13_.color = const_818;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_815;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_817;
               }
               else
               {
                  _loc13_.color = const_816;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1253)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_104,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1019);
            if(_loc3_ != var_2310)
            {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_729));
            if(_loc4_ != var_1154)
            {
               var_1154 = _loc4_;
               var_2311 = var_1154 & 255;
               var_2312 = var_1154 >> 8 & 255;
               var_2313 = var_1154 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1003));
            if(_loc5_ != var_1675)
            {
               var_1675 = _loc5_;
               _loc2_ = true;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_670 == null)
         {
            var_670 = super.boundingRectangle;
         }
         return new Rectangle(var_670.x,var_670.y,var_670.width,var_670.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_453.maskCount)
         {
            _loc10_ = var_453.getMaskType(_loc8_);
            _loc11_ = var_453.getMaskLocation(_loc8_);
            _loc12_ = var_453.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < var_109.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_104 || _loc3_.type == RoomPlane.const_87)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_104 || _loc3_.type == RoomPlane.const_87 && _loc12_ == RoomPlaneBitmapMaskData.const_212)
                              {
      ...
      {
         if(param1 != var_332["null"] || param2 != var_332["null"] || param3 != var_332["null"])
         {
            var_332["null"] = param1;
            var_332["null"] = param2;
            var_332["null"] = param3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc7_ < var_2157 + const_1740 && !_loc4_ && !_loc6_)
         {
            return;
         }
         ...
         while(_loc8_ < var_212.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_87)
            {
               if(var_1675)
               {
                  ...
                  _loc13_ = uint((_loc12_ & 255) * var_2311 / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * var_2312 / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * var_2313 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != var_1264)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != var_1061 || _loc3_.y != var_1896 || _loc3_.z != var_1899 || param1.scale != var_1895))
            {
               var_1061 = _loc3_.x;
               var_1896 = _loc3_.y;
               var_1899 = _loc3_.z;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : void
      {
         ...
         if(var_170 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_752);
            updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_617));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_737));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_749));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + var_1626;
      }
