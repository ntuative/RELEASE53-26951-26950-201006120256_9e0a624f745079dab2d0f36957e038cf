package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1306:int = const_309;
      ...
      public static const const_278:int = const_107;
      ...
      private var var_627:Vector3d = null;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1568 == const_107)
         {
            _loc5_ = new Rectangle(0,0,var_24.width,var_362);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_362,var_24.width,var_362);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_24 != null)
            {
               if(var_24.width == param2 && var_24.height == param3 && Vector3d.isEqual(var_627,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_362,param6,param7);
                     return param1;
                  }
                  return var_24;
               }
