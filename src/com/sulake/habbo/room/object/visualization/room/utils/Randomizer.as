package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1582:int = 16777216;
      
      public static const const_1537:int = 1;
       
      
      private var var_2488:int = 69069;
      
      private var var_1288:int = 1;
      
      private var var_2489:int = 5;
      
      private var var_1553:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1553 * param2);
      }
      ...
      {
         var _loc1_:int = var_2488 * var_1288 + var_2489;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
