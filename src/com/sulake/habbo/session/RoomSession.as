package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1063:UserDataManager;
      ...
      {
         if(var_35 == RoomSessionEvent.const_317 && _connection != null)
         {
      ...
      {
         return var_1063 as IUserDataManager;
      }
