package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1139:Number = 90;
      
      private static const const_769:int = 50;
      
      private static const const_1061:Number = 25;
      
      private static const const_1062:int = 50;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1033 = param2;
         var_592 = new Timer(const_1061);
         var_592.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_484.push(param2);
         param1.addEventListener(WindowEvent.const_392,windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_593[_loc3_] = new Array();
            }
            if(var_593[_loc3_].indexOf(param1) < 0)
            {
               var_593[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_769 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_769 || param1.desktop.height - param1.y < const_1062;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_485.length)
         {
            if(var_485[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_593[_loc3_].length)
                  {
                     repositionWindow(var_593[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
