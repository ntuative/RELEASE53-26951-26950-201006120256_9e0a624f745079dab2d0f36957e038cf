package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_986:Number = 0.0;
      
      private var var_565:Point = null;
      
      private var _isDisposed:Boolean = false;
      
      private var var_384:Map = null;
      
      private var var_803:Map = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_385.length)
            {
               _loc2_ = var_385.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(var_384 != null)
         {
            ...
            {
               _loc2_ = var_384.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = var_384.getValue(_loc15_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = var_385.getValue(_loc15_) as BitmapData;
                           }
                           _loc12_ = uint(var_803.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_209)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       var_384.add(_loc15_,_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    var_385.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_803.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_705,RoomWidgetChatSelectAvatarMessage.const_612];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_705:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_146,_container.roomSession,0,"Version 26951-26950-201006120243");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_612:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_986 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_986);
            }
            if(var_565 == null)
            {
               var_564.x = 0;
               var_564.y = 0;
               var_564.z = 0;
               var_565 = _loc4_.getScreenPoint(var_564);
               var_986 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_564.x = 0;
            var_564.y = 0;
            var_564.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_564);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_565.x || _loc8_.y != var_565.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_565,_loc5_));
