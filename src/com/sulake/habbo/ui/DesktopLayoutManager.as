package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1100:String = "room_view";
      
      private var var_51:IWindowContainer;
      
      private var var_754:int = 50;
      
      private var var_2452:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_51.getChildByTag(const_1100) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_51.findChildByTag(const_1100) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_754;
               _loc2_.width = var_51.desktop.width - var_754;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_754;
               _loc2_.height = var_51.desktop.height - var_754;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_51.desktop.width;
