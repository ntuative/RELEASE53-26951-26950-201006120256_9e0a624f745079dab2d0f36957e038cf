package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_635);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_760);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_608);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_274:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_635:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_760:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_608:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_274);
         return _loc1_;
      }
