   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_143,onUserTags);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_143,onUserTags);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_358);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_312)
               {
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_206)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_532);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1292;
                  if(!_loc25_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1320);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_636.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_54);
            var_636.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_532);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_136];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_579);
         _loc1_.push(RoomWidgetFurniActionMessage.const_575);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_699);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_711);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1310);
         _loc1_.push(RoomWidgetPetCommandMessage.const_576);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_136:
      ...
      public function dispose() : void
      {
         ...
         if(var_636 != null)
         {
            _loc1_ = var_636.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_636.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_437)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_601:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_579:
            ...
            case RoomWidgetRoomTagSearchMessage.const_699:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_711:
            ...
            case RoomWidgetPetCommandMessage.const_738:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_576:
