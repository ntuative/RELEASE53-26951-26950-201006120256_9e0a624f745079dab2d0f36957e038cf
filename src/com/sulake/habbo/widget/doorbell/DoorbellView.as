package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_55 = (_doorbell.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_55 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_50 = var_55.findChildByName("user_list") as IItemListWindow;
         var_55.visible = false;
