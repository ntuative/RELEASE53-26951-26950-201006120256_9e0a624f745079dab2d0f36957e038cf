package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_490:BitmapData;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            _loc3_.width = var_490.width;
            _loc3_.height = var_490.height;
            var_408.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_490.width,var_490.height,true,0);
               _loc4_.bitmap.copyPixels(var_490,var_490.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_847.width,var_847.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_703.width,var_703.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_703,var_703.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_408.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_408.numGridItems)
         {
            return;
         }
         select(var_408.getGridItemAt(param1) as IWindowContainer);
      }
