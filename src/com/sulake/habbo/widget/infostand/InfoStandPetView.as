package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1727:String = "level";
      ...
      private const const_1724:String = "nutrition";
      
      private var var_63:IItemListWindow;
      
      private const const_1729:uint = 3355443;
      
      private var var_236:IBorderWindow;
      
      private const const_1728:int = 158;
      
      private const const_1732:int = 16;
      ...
      private const const_1725:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_236 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_236 != null)
         {
            var_106 = var_236.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_236.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_236.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_106 == null || var_236 == null || var_63 == null)
         {
            return;
         }
         ...
         var_236.height = NaN;
         _window.width = Math.max(var_236.width,var_63.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1344.getValue(var_606) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1727,param1.level,param1.levelMax);
         updateStateElement(const_1725,param1.experience,param1.experienceMax);
         updateStateElement(const_1726,param1.energy,param1.energyMax);
         updateStateElement(const_1724,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_606 = param1.id;
         var_1344.remove(param1.id);
         var_1344.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_181 && var_181.getPetId() == var_606)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_508,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1728,const_1732,false);
         ...
         _loc5_.fillRect(_loc6_,const_1729);
