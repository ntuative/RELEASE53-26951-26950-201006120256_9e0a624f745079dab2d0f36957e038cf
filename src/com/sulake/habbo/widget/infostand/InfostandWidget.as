package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1460:String = "infostand_user_view";
      
      private var var_321:InfoStandPetView;
      
      private var var_1344:InfoStandPetData;
      
      private var var_136:Timer;
      
      private var var_922:InfoStandFurniView;
      ...
      private const const_1457:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1459:String = "infostand_pet_view";
      
      private const const_1458:String = "infostand_furni_view";
      
      private const const_1736:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_922 = new InfoStandFurniView(this,const_1458);
         var_205 = new InfoStandUserView(this,const_1460);
         var_321 = new InfoStandPetView(this,const_1459);
         var_372 = new InfoStandBotView(this,const_1457);
         var_420 = new InfostandUserData();
         var_430 = new InfostandFurniData();
         var_1344 = new InfoStandPetData();
         var_136 = new Timer(const_1736);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_205.setTags(param1.tags,var_2085);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_136,onUserBadges);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_462,var_321.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_136,onUserBadges);
      ...
      {
         userData.setData(param1);
         var_372.update(param1);
         selectView(const_1457);
         if(var_136)
         {
            var_136.stop();
         }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_372.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_263:
               ...
               {
                  _loc2_ = param1.id == var_1344.roomIndex;
                  break;
               }
               if(var_372 != null && false && var_372.window.visible)
               {
                  _loc2_ = param1.id == var_420.userRoomId;
                  break;
               }
