package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1734:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1358 != null && var_1358.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_916 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_916 += param1.height + const_1733;
            return fit(param1);
         }
         param1.offset(_offsetX,var_916);
         _offsetX += param1.width + const_1734;
         return true;
      }
