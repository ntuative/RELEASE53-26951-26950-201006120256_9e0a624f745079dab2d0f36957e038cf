   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_851 = _window.findChildByName("effect_hilite");
            var_851.visible = false;
         }
         var_850 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_849 = _window.findChildByName("loader_bar");
         if(var_849 != null)
         {
            var_406 = var_849.width;
            var_174.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_850 != null)
         {
            var_850.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_850.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
