package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_696:Array = null;
      ...
      private var var_1037:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_140,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_139,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_322,update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1767;
         if(_loc2_ > var_1225)
         {
            method_3();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_140,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_139,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_322,update);
      }
