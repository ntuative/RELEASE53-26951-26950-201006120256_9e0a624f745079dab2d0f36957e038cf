package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_161.state = RoomChatHistoryPulldown.const_219;
         ...
         var_44 = param2.createWindow("chatscroller","",HabboWindowType.const_913,HabboWindowStyle.const_41,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_325 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_247 > 0 && param2)
         {
            if(var_1399)
            {
               if(Math.abs(param1 - var_247) <= const_881)
               {
                  return;
               }
               var_1399 = false;
            ...
            if(var_325)
            {
               ...
               _loc3_ = var_377 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_247;
               _loc7_ = true;
               _loc8_ = true;
               if(var_44.scrollV < 1 - const_1143 / var_44.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1639)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_325 && !var_1291)
         {
            ...
            var_161.state = RoomChatHistoryPulldown.const_353;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_161.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_219);
      }
