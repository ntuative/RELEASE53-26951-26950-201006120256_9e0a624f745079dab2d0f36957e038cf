package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_525:int = 6;
      
      private static const const_373:int = 10;
      
      private static const const_1161:Number = 18;
      
      private static const const_1473:Number = 10;
      
      private static const const_1472:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1162,var_1163,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1162,var_806,var_1163,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1441 = param1.chatType;
         var_1162 = param1.userId;
         var_806 = param1.userName;
         var_1163 = param1.userCategory;
         _message = param1.text;
         var_1442 = param1.userX;
         var_215 = param1.userImage;
         var_1164 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1441)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_112:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_296:
         ...
         if(var_215 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_460 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1164 != 0)
            {
               _loc30_ = uint(var_1164 >> 16 & 255);
               _loc31_ = uint(var_1164 >> 8 & 255);
               _loc32_ = uint(var_1164 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1441 == RoomWidgetChatUpdateEvent.const_296)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_806);
            }
            else if(var_1441 == RoomWidgetChatUpdateEvent.const_281)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_806);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_460;
            _loc20_.width = _loc20_.textWidth + const_525;
            _width += _loc20_.textWidth + const_525;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_373 + _loc20_.textWidth + const_525;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1162,var_1163,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1162,var_1163,_roomId,_roomCategory,param1);
      }
