package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      private var var_766:IWindowRenderer;
      
      private var var_457:IProfiler;
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_457.addStopEventListener(refresh);
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_745)
            {
               var_1435 = false;
               ITextWindow(_window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = var_457.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_457.removeStopEventListener(refresh);
            var_457 = null;
            _windowManager = null;
            var_766 = null;
            _disposed = true;
