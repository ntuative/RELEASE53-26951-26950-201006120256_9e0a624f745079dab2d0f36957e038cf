package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function setString(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_481[param1] != param2)
         {
            var_481[param1] = param2;
         }
      }
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_126)
               {
                  var_126.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_126)
                  {
                     var_126.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
