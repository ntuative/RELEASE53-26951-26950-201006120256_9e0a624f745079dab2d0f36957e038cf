package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1471:int = 50;
      ...
      private var var_250:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1682:Boolean = false;
      
      private var var_2320:Number = -1.0E7;
      
      private var var_2318:Number = -1.0E7;
      
      private var var_2491:int = 0;
      
      private var var_560:RoomObjectCache;
      
      private var var_801:int;
      
      private var var_294:Sprite;
      
      private var var_1159:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_250 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_335 = new Map();
         var_560 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_250.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_250.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_560.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_982 == 0)
         {
            checkMouseHits(var_1158.x,var_1158.y,MouseEvent.MOUSE_MOVE);
         }
         var_982 = 0;
         ++var_811;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_294 != null)
         {
            var_294.graphics.clear();
         }
         else
         {
            var_294 = new Sprite();
            var_294.name = "mask";
            _master.addChild(var_294);
         }
         var_294.graphics.beginFill(0);
         var_294.graphics.drawRect(0,0,param1,param2);
         var_801 = param1;
         var_800 = param2;
         var_54.graphics.clear();
         var_54.graphics.beginFill(var_2491);
      ...
      {
         var _loc11_:Number = param1 - var_801 / 2;
         var _loc12_:Number = param2 - var_800 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_801 != var_2317 || var_800 != var_2319)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_459.sortOn("z",0 | 0);
         if(_loc5_ < var_459.length)
         {
            var_459.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_459[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_562.length)
            {
               cleanSprite(var_562[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_562 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_335 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_335.getKey(_loc1_);
            _loc3_ = var_335.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1159 != null)
                  {
                     var_1159.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_811,geometry);
                  }
                  else
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        _loc5_.method_1(_loc3_,_geometry);
                     }
                  }
               }
            }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_250.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_250.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1158.x = param1;
         var_1158.y = param2;
         if(var_982 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1682;
         }
         var_1682 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_982;
         return var_1682;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_459.length)
         {
            return null;
         }
         return var_459[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_335 != null && param1 != null)
         {
            var_335.add(param2,param1);
         }
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2320 || param2 != var_2318)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_562.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_250.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_250.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_560.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_560.getObjectCache(param2);
         ...
         _loc13_ += int(var_801 / 2);
         _loc14_ += int(var_800 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_801 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_800))
                  {
